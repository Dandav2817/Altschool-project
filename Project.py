...
class Expense:
    def __init__(self, title, amount):
        """
        This funtion initializes the attributes
        """
        self.id = str(uuid4())
    ...
    def update(self, title = None, amount = None):
        """
        This function allows updating the title and/or amount of the expense
        """
        self.title = title
        self.amount = amount
        self.updated_at = datetime.utcnow()
...
class ExpenseDatabase:
    def __init__(self):
        """
        This function initializes the expenses list
        """
        self.expenses = []
    ...
    def remove_expense(self, expense_id):
        """
        This function removes an expense from the database
        """
    ...
    def get_expense_by_title(self, expense_title):
        """
        This function get expenses by title and returns a list
        """
